...
class InitializeInterface(object):
    ...
    def load_world(self):
        ...
        self.interface.configure_vehicle(self.ego_actor)
...
def main():
    ...
    try:
        ...
        # Register signal handlers after setup; failures during setup still
        # release actors, sensors, and ROS resources through the finally block.
