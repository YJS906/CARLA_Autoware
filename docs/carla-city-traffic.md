...
현재 저장한 설정은 **배경 차량 0대·보행자 250명**이다. 에고와 시나리오 편집기 차량은 배경 차량 목표에 포함하지 않는다. 2026-09-23 기존 250대·500명에서 75대·250명으로 줄인 뒤, 이번 저장 시점의 파일에는 차량 목표가 0대로 설정돼 있다. 이는 컨트롤러의 목표이며 실제 월드의 모든 차량이 없다는 뜻은 아니다. 아래 성능 표와 회피 주행 기록은 각 시험 당시 교통량의 기록이다.
