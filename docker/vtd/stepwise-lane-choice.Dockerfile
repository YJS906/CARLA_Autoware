...
COPY vtd_overlay/src/autoware_universe/planning/behavior_path_planner/autoware_behavior_path_planner/src/planner_manager.cpp /opt/selfcar-build/src/autoware_universe/planning/behavior_path_planner/autoware_behavior_path_planner/src/planner_manager.cpp
RUN source /opt/ros/jazzy/setup.bash && source /opt/autoware/setup.bash && source /opt/selfcar_overlay/setup.bash && \
    ...
    colcon --log-base /tmp/stepwise-log build \
      ...
      --packages-select autoware_behavior_path_planner autoware_behavior_path_lane_change_module autoware_behavior_path_avoidance_by_lane_change_module autoware_behavior_path_external_request_lane_change_module \
...
COPY --from=build /opt/selfcar-build/src/autoware_universe/planning/behavior_path_planner/autoware_behavior_path_planner/src/planner_manager.cpp /opt/selfcar-build/src/autoware_universe/planning/behavior_path_planner/autoware_behavior_path_planner/src/planner_manager.cpp
